...
Ext.define('KlbDesktopApp.Settings', {
    ...
    createTree : function() {
        ...
        var tree = new Ext.tree.Panel({
            ...
            store: new Ext.data.TreeStore({
                model: 'KlbDesktopApp.model.Wallpaper',
                root: {
                    text:'Wallpaper',
                    expanded: true,
                    children:[
    ...
    onSelect: function (tree, record) {
        ...
        if (record.data.img) {
            me.selected = KlbSys.paths['Klb.desktop'] +'/resources/images/wallpapers/' + record.data.img;
        } else {
